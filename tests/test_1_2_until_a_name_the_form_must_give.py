...
def test_poetic_line_to_filename():
    ...
    assert _1_2_until_a_name_the_form_must_give.poetic_line_to_filename("  no_slashes break no:colons bind ") == "no_slashes_break_no_colons_bind.py"
    ...
    assert _1_2_until_a_name_the_form_must_give.poetic_line_to_filename("must-keep?it*safe|&clean!") == "must_keep_it_safe_clean.py"
